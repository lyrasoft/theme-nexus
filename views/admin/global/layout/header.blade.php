            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="{{ $nav->to('home') }}" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ $asset->path('images/logo.svg') }}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ $asset->path('images/logo.svg') }}" alt="" height="17">
                        </span>
                    </a>

                    <a href="{{ $nav->to('home') }}" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="{{ $asset->path('images/logo-light.svg') }}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ $asset->path('images/logo-light.svg') }}" alt="" height="19">
                        </span>
                    </a>
                </div>
